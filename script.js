...
function playMeowSound() {
  // Tady zadej přesný název tvého staženého souboru (např. meow.mp3)
  var audio = new Audio('meow.mp3'); 
  
  audio.currentTime = 0; // Tohle zajistí, že to bude mňoukat i při rychlém klikání
  audio.play();
}
